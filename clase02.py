...
cadena4 = cadena1 * 4
print (cadena4, '| Tiene una longitud es: ', len(cadena4))

cadena5 = cadena3[5:10]  
#Substring
print (cadena5)
...
nombre_formal = nombre + paterno + materno
print ('')
print (nombre_formal)
print ('La longitud es: ', len(nombre_formal))
print ('Subcadena Apellido Paterno: ', nombre_formal[7:12])

print ('')

#Devuelve -1 si no encuentra la cadena
print (nombre_formal.find('Tito'))

print('EN MAYUSCULAS: ', nombre_formal.upper())
print ('en minusculas: ', nombre_formal.lower())
